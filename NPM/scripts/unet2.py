...
def cbr_block(num_features, in_layer):
    beta2=1e-4
    # CBR
    x = tf.keras.layers.Conv2D(num_features, 2, padding='same', kernel_initializer='he_normal',kernel_regularizer=tf.keras.regularizers.l2(beta2),bias_regularizer=tf.keras.regularizers.l2(beta2),activity_regularizer=tf.keras.regularizers.l2(beta2))(in_layer)
    x = tf.keras.layers.BatchNormalization()(x)
    x = tf.keras.layers.Activation('relu')(x)

    # CBR
    x = tf.keras.layers.Conv2D(num_features, 2, padding='same', kernel_initializer='he_normal',kernel_regularizer=tf.keras.regularizers.l2(beta2),bias_regularizer=tf.keras.regularizers.l2(beta2),activity_regularizer=tf.keras.regularizers.l2(beta2))(x)
    x = tf.keras.layers.BatchNormalization()(x)
    # x = tf.keras.layers.Activation('relu')(x)

    # Residual connection
    x0 = tf.keras.layers.Conv2D(num_features, 1, padding='same', kernel_initializer='he_normal',kernel_regularizer=tf.keras.regularizers.l2(beta2),bias_regularizer=tf.keras.regularizers.l2(beta2),activity_regularizer=tf.keras.regularizers.l2(beta2))(in_layer)
...
def unet(input_size=(None, None, 1), l_rate=1e-4, f=32, num_classes=2):
    ...
    if num_classes == 1 or num_classes == 2:
        conv10 = tf.keras.layers.Conv2D(1, 2, padding='same', kernel_initializer='he_normal',kernel_regularizer=tf.keras.regularizers.l2(beta2),bias_regularizer=tf.keras.regularizers.l2(beta2),activity_regularizer=tf.keras.regularizers.l2(beta2))(conv9)
        conv11 = tf.keras.layers.Add()([conv10, inputs])
        decoded = tf.keras.layers.Conv2D(1, 1, activation='sigmoid',kernel_regularizer=tf.keras.regularizers.l2(beta2),bias_regularizer=tf.keras.regularizers.l2(beta2),activity_regularizer=tf.keras.regularizers.l2(beta2))(conv11)
        ...
        decoded = tf.keras.layers.Conv2D(num_classes, 1, activation='softmax',kernel_regularizer=tf.keras.regularizers.l2(beta2),bias_regularizer=tf.keras.regularizers.l2(beta2),activity_regularizer=tf.keras.regularizers.l2(beta2))(conv9)
        model = tf.keras.Model(inputs=inputs, outputs=decoded)
